...
<div id="container-2" class="box1">
	<div id="stockbydeptlist" style="padding:50px 0 0 0;display:block;">
		<form name="searchdept" action="otherstockreportbydepartment.php" method="post">
		...
		<tr>
			<td colspan="4"><input type="submit" name="dosearch" id="dosearch" value="Search" >&nbsp;<input type="button" name="remfilter" id="remfilter" value="Remove Filter" onclick="window.location='otherstockreportbydepartment.php';" ></td>
		</tr>
		</table>
		</form>
