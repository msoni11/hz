		...
		<div id="center">
			<form name="ipform" id="ipform" action="#" method="post" onSubmit="return false;">
				...
				<div class="text-box-field">
					<input type="text" name="location" id="location" value="" class="form-text" size="30" maxlength="2048" />
				</div>
				<div class="text-box-field"></div>
                
                
                
                <input type="button" name="newlocation" id="newlocation" value="submit" style="width:80px; height:30px;margin-left:90px" /> 
