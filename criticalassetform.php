<?php
$unitcode = 'HZL/CZ/';
$assetcode = explode(',', $criticalassetcode);
$location = explode('#', $criticallocation);
$ipsubnet = explode(',', $ipsubnet);
$configprocessor = explode(',',$configprocessor);
$configram = explode(',',$configram);
$confighdd = explode('#',$confighdd);
$configcdrom = explode(',',$configcdrom);
$swOs = explode(',',$swOs);
?>
...
<div id="container" class="box1">
	<div id="obsah" class="content box1">
		<div id="center">
			<form name="criticalform" action="#" method="post" onSubmit="return false;">				<fieldset><legend>Registration</legend>
